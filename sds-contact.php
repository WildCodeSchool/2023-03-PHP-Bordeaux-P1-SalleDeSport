...
<div class="main-contact">
    <div class="container-contact">
        ...
        <div id="center">
            <button onclick="openAlert()" class="bouton submit" id="boiteD">Submit</button>
            <div class="box">
                <div class="boite-contenu animation-top">
                    <div class="container-form-header">
                        <div onclick="closeAlert()" class="bouton affichage">&times;</div>
                        <h4>Information</h4>
                    </div>
